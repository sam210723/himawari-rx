...
tsp -I file --infinite "E:\RF\HimawariCast\TS\154.0E_4148H_2586_(2020-09-20 1121 UTC)_6983.ts" -P regulate --bitrate 3075700 -P mpe --pid 0x03E9 --udp-forward --log -O drop
