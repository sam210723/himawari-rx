...
tsp -I file --infinite "E:\RF\HimawariCast\ts\154.0E_4148H_2586_(2020-07-06 0936 UTC)_FILTERED.ts" -P regulate --bitrate 500000 -P mpe --pid 0x03E9 --udp-forward --log -O drop
