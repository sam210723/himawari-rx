...
tsp -I file --infinite "E:\RF\HimawariCast\ts\154.0E_4148H_2586_(2020-09-20 1136 UTC)_6903X_FILTERED.ts" -P regulate --bitrate 500000 -P mpe --pid 0x03E9 --udp-forward --log -O drop
